...
import Bg from "/images/timersec/bg.png";
import Shroomie from "/images/timersec/s.png";
import PurpleEye from "/images/timersec/Eye.png";
              ...
              <div className="container-div mt-24 md:mt-[20rem]">
                <div className="container-1">
                  <div className="w-[151px] flex text-white items-center bg-[#3B3B3B] rounded-2xl px-5 py-2 gap-2">
                    <div className="img-div cursor-pointer">
