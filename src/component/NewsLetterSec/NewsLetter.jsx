...
import n1 from "/images/newsletterSec/n1.png";
import Envelope from "/images/newsletterSec/EnvelopeSimple.png";
                ...
                <form action="">
                  <div className="flex flex-col lg:flex-row mt-5 gap-3 lg:gap-0 lg:relative">
                    ...
                    <div className="lg:absolute right-0">
                      <button
                        type="submit"
                        className="flex w-full lg:text-base items-center justify-center gap-2 rounded-2xl bg-[#A259FF] px-14 2xl:px-24 py-2 lg:py-5 hover:bg-[#af72ff]"
                      >
